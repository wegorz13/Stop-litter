  ...
  const krakowReports: ReportInterface[] = [
    {
      ...
      description: "Duży ubytek w asfalcie, stwarzający zagrożenie dla rowerzystów i samochodów.",
    ...
    },
    {
      ...
      description: "Po wczorajszej burzy drzewo zablokowało ścieżkę dla pieszych w centralnej części parku.",
    ...
    },
    {
      ...
      description: "Ściana zabytkowej kamienicy została zniszczona przez wandali.",
    ...
    },
    {
      ...
      description: "Nie działa sygnalizacja na skrzyżowaniu, powodując utrudnienia w ruchu.",
    ...
    },
    {
      ...
      description: "Kosze nie były opróżniane od kilku dni, śmieci wysypują się na chodnik.",
    ...
    },
    {
      ...
      description: "Po porannym deszczu przejście jest częściowo zalane, utrudniając przejście pieszym.",
    ...
    },
    {
      ...
      description: "Rozbite szkło na przystanku tramwajowym, stwarzające zagrożenie dla oczekujących.",
    ...
    },
    {
      ...
      description: "Stado dzików regularnie pojawia się wieczorami w okolicy bloków mieszkalnych.",
    ...
    },
    {
      ...
      description: "Brak oświetlenia na odcinku około 200 metrów, co stwarza zagrożenie dla bezpieczeństwa.",
    ...
    },
    {
      ...
      description: "Kilka samochodów zaparkowanych na chodniku, blokujących przejście dla pieszych.",
